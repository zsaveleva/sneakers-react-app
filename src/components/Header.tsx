...
import { openCart } from "../store/reducers/cartItemsReducer";
...
export const Header: FC = () => {
    ...
    return (
        <header className='d-flex justify-between align-center p-40'>
            ...
            <ul className='d-flex'>
                <li onClick={() => dispatch(openCart())} className='d-flex align-center mr-30 cu-p'>
                    ...
                    <span className='pl-10'>{totalPrice} руб.</span>
                </li>
